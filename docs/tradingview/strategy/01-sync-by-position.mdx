...
#### Step 5: Click on `Lock` to view and set up how you want to enter a trade.
...
<details><summary>Expand to see all Order Modes</summary>
<p>
...
<details><summary>See How To Set Up TradingView Alert Webhook</summary>
